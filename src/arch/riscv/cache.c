...
{
    /**
     * Currently the typical of way for system software to discover cache topology is to read it of
     * a dtb passed by the bootloader. As we are not implementing an fdt parser, a platform port
     * must add it to the platform description.
     */
