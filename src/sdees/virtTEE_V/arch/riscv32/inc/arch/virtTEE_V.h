...
#define FID_CHILD_IDX_MASK    0x0F000000
#define FID_CHILD_IDX_SHIFT   24
#define FID_GET_CHILD_IDX(fid) (((fid) & FID_CHILD_IDX_MASK) >> FID_CHILD_IDX_SHIFT)
#define FID_HIERARCHY_BIT    (1UL << 28)
